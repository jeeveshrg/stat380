---
title: "Homework 1"
author: "[Jeevesh Gupta]{style='background-color: yellow;'}"
toc: true
...
num_elements_greater_than_zero <- sum(my_vec_double > 0)
print(my_vec_bool)
print(num_elements_greater_than_zero)
#d)
...
row_wise_result <- row_wise_scan(M)
...
col_wise_result <- col_wise_scan(M)
print(col_wise_result)
...
col_wise_scan, better cache locality
...
time_scan <- function(f, M) {
    timings <- system.time(f(M))
    total_time_taken <- timings[3]
...
list(time_100 = time_100, time_1000 = time_1000, time_5000 = time_5000)
```
as matrix size increases, both functions show an increase in the time taken. linear time complexity vs matrix size.
<br><br><br><br>
---
